...
from PIHUMUSIC.misc import SUDOERS
from PIHUMUSIC.utils.database import add_sudo, remove_sudo
from PIHUMUSIC.utils.decorators.language import language
from PIHUMUSIC.utils.extraction import extract_user
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_photo(photo="https://graph.org/file/79553d224c5dd4c35d03c-305e6a0d178a3982ee.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("Pata Nahi Bro 😂 \n 𝗦ᴜᴅᴏʟɪsᴛ 𝗗ᴇᴋʜɴᴇ ᴀᴀʏᴀ pagl 🤧🖕", show_alert=True)
    else:
