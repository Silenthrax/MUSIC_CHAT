...
from PIHUMUSIC.utils import PIHUBin, get_channeplayCB, seconds_to_min
from PIHUMUSIC.utils.database import get_cmode, is_active_chat, is_music_playing
from PIHUMUSIC.utils.decorators.language import language, languageCB
from PIHUMUSIC.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://graph.org/file/a3f70fb41542e48738584-807b2fc7ba7483f6d9.jpg",
        caption=_["queue_1"],
    )
